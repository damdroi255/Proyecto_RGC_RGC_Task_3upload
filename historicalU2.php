        ...
        if (mysqli_num_rows($result) > 0) {
            while($row = mysqli_fetch_assoc($result)) {
                ...
                if($indice == $row["id"]){
                    ...
                    echo '<td><input type="date" name="timestamp_date" form="formhistoricalU" value="'.$row["timestamp_date"].'"/></td>';
                    ...
                    echo '<td><input type="date" name="phase_date" form="formhistoricalU" value="'.$row["phase_date"].'"/></td>';
                    echo '<td><input type="text" name="technician" form="formhistoricalU" value="'.$row["technician"].'"/></td>';
                    echo '<td><input type="date" name="commitment_date" form="formhistoricalU" value="'.$row["commitment_date"].'"/></td>';
